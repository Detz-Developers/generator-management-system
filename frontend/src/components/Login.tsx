...
export default function Login({ onLogin }: LoginProps) {
  ...
  const getUserRole = (email: string): string => {
    ...
    if (emailLower.startsWith('operate')) return 'operate';
    if (emailLower.startsWith('tech')) return 'tech';
    if (emailLower.startsWith('invent')) return 'invent';
    return 'admin'; // Default to admin if no prefix matches
  };
