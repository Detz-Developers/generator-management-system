...
export default function OperatorSidebar({ onNavigate, currentPage, onLogout }: OperatorSidebarProps) {
    ...
    <div className={`bg-white shadow-lg transition-all duration-300 ${isCollapsed ? 'w-16' : 'w-64'} h-screen flex flex-col`}>
      ...
      <div className="p-4 border-b border-gray-200">
        <div className="flex items-center justify-between">
          {!isCollapsed && (
            <div>
              <h1 className="text-lg font-bold text-green-600">Operator Panel</h1>
              <p className="text-xs text-gray-500">Generator Operations</p>
            </div>
          )}
          <button
